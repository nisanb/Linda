...
extern json_spirit::Value getCoinAge(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getstakesubsidy(const json_spirit::Array& params, bool fHelp);
extern json_spirit::Value getStakeRewardByCoins(const json_spirit::Array& params, bool fHelp);
